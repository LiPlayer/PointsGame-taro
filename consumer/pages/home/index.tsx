...
import { getUserData, initUserData, getDecayedPoints, startPointsListener } from '@shared/utils/user'
            ...
            >
                ...
                <View className="space-y-4 mb-6 relative z-20">
                    ...
                    <View
                        ...
                        onClick={() => {
                            const games = [
                                { name: 'Stack (堆叠)', path: '/games/Stack/index' },
                                { name: 'KnifeHit (神厨飞刀)', path: '/games/KnifeHit/index' }
                            ]
                            Taro.showActionSheet({
                                itemList: games.map(g => g.name),
                                success: (res) => {
                                    const selected = games[res.tapIndex]
                                    if (selected) {
                                        Taro.navigateTo({ url: selected.path })
                                    }
                                },
                                fail: () => {
                    ...
                    >
                        <Text className="text-[10px] font-bold text-slate-400">DEBUG: 调试游戏入口</Text>
                    </View>
                </View>
