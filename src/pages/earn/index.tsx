...
const Earn: FC = () => {
    const [viewState, setViewState] = useState<ViewState>(ViewState.ENTRY)
    ...
    const handleStart = () => {
        ...
        if (random < 0.3) {
            setViewState(ViewState.INSTANT_WIN)
        } else {
            setViewState(ViewState.GAME_ENCOUNTER)
        }
    }
    ...
    return (
        <View className="block">
            ...
            {viewState === ViewState.INSTANT_WIN && (
            ...
            {viewState === ViewState.GAME_ENCOUNTER && (
