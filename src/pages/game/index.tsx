...
const Game: FC = () => {
    ...
    return (
        <View className="flex flex-col h-screen bg-slate-900 relative overflow-hidden">
            ...
            <View className="absolute top-0 left-0 w-full p-6 flex justify-between items-start z-10 box-border">
                <View
                    className="w-10 h-10 rounded-full bg-white/20 backdrop-blur flex items-center justify-center mt-6 active:bg-white/40"
                    onClick={goHome}
                >
