 ...
 * @param {number} lastPoints - Points at last update
 * @param {number} lastUpdatedAt - Timestamp (ms) of last update
 * @returns {number} Current points
 */
export function calculateCurrentPoints(lastPoints, lastUpdatedAt) {
